            ...
            {status === "sent" ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#1e2a6e] text-white font-semibold text-sm py-3 rounded-lg hover:bg-[#16205a] transition disabled:opacity-60"
                >
                ...
                {status === "error" && (
                  <p className="text-center text-xs text-red-500">Something went wrong. Please try again or call us directly.</p>
                )}
